                     ...
                     <tr>
                      ...
                      <td>
                        <a class="btn btn-warning btn-xs" href="{{ URL::to('administrador/categorias/ver-sub-categorias/'.$c->id) }}"> 
                     	...
                     	<td>
                        <button class="btn btn-danger btn-xs btn-elim-sub-cat" value="{{ $c->id}}" data-toggle="modal" data-target="#elimCat"> 
                          Eliminar
                        </button>
                      </td>
                     </tr>
        ...
        <div class="alert responseAjax">
          <p></p>
			...
			<div class="modal-footer">
				<img src="{{ asset('images/loader.gif') }}" class="miniLoader">
				<button type="button" class="btn btn-danger btn-elim-sub-cat-modal">Eliminar</button>
			</div>
		</div>
	</div>
</div>
