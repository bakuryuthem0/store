      ...
      <div class="col-md-9">
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <div class="tab-pane fade margin-top-1 in  @if(!Session::has('act') || Session::get('act') == 'perfil') active in @endif" id="settings">
             ...
             <div class="tab-pane fade margin-top-1 @if(Session::has('act') && Session::get('act') == 'pass') active in @endif" id="pass" >
              @if(Session::has('success'))
              <div class="alert alert-success">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                {{ Session::get('success') }}
