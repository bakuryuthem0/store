...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="{{ Request::url() }}"><i class="fa fa-ticket"></i> Modificar Categoría</a></li>
    </ol>
  </section>
  <div class="row">
        ...
        <div class="box-body chat" id="chat-box">
          ...
          <div class="col-xs-12">
            <form class="new-user-form" method="POST" action="{{ URL::to('administrador/categorias/ver-categorias/'.$cat->id.'/enviar') }}"  enctype="multipart/form-data">
              ...
              <div class="input-group">
                <input type="text" class="form-control" placeholder="Nombre de la categoría" name="name" value="{{ $cat->description_es }}">
              </div>
              <div class="input-group">
                <label>(*) Nombre de la categoría (ingles)</label>
              </div>
              <div class="input-group">
                <input type="text" class="form-control" placeholder="Nombre de la categoría" name="name_eng" value="{{ $cat->description_eng }}">
              </div>
            </form>
          </div>
